...
window = Tk()
window.title('Numeral systems converter')
window.geometry('332x149')
window.resizable(width=False, height=False)

converter = LabelFrame(window, text='Converter', font=('Consolas', 10))
calculator = LabelFrame(window, text='Calculator', font=('Consolas', 10))
converter.grid()
calculator.grid()
...
main_lbl = Label(converter, text='- Convertation result -', font=('Consolas', 10))
...
def convert():
    ...
    if choice.get() == 'BIN':
        ...
        main_lbl.configure(text='- Convertation result -', fg='#000000')
        ...
        choice.current(randint(0, 3))
        main_lbl.configure(text='- Choose correct source system -', fg='#FF0000')

convert = Button(converter, text='Convert', command=convert, width=15, font=('Consolas', 10))
